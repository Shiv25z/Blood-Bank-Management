...
<div style="height:530px; width:700px; margin:auto; margin-top:10px; margin-bottom:10px; background-color:#F46E33; border:2px solid black; box-shadow:4px 1px 20px black;">
...
<tr><td colspan="2">&nbsp;</td></tr>
                ...
                <tr><td  style=" padding-left:20px;" ><img src="Images/sidebanner1.jpg" width="170px" class="shaddoww"/>&nbsp; </td>
...
<tr><td>&nbsp;</td><td><input type="submit" value="Resitred" name="sbmt" style="border:0px; background:linear-gradient(#960,#DEB887); width:100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr></table>
</td></tr>
</table>
</form>
        </div>
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
			<p class="title">© All Rights Reserved | Design by RRMCH |</p>
		</div>
	<div class="clear"></div>
</div>
</div>
