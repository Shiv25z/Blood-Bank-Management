...
<div style="height:400px; width:600px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#F46E33; border:2px solid black; box-shadow:4px 1px 20px black;">
